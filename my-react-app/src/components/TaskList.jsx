...
import { Box, Heading, Text, Button, Spacer, Divider } from "@chakra-ui/react";
...
export function TaskList() {
    ...
    return (
        <Box display="flex" justifyContent="center" alignItems="center" flexDirection="column">
            ...
            <Box w="80vh" display="flex" justifyContent="center" bg="green.200" borderRadius="3xl" padding="4" flexDirection="column">
                <Header />
